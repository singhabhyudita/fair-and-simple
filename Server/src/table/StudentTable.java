...
public class  StudentTable  {
    ...
    public static final String UPDATE_PROFILE_PIC = "UPDATE " + TABLE_NAME + " SET " + COLUMN_PROFILE_PIC
            + " = ? WHERE " + COLUMN_REGISTRATION_NUMBER + " = ?";
    public static final String SELECT_PROFILE_PIC="SELECT "+COLUMN_PROFILE_PIC+" FROM "+TABLE_NAME+" WHERE "
