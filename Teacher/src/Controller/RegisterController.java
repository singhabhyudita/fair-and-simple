...
public class RegisterController {
    ...
    public void register(ActionEvent actionEvent) {
        FXMLLoader loginLoader=new FXMLLoader(getClass().getResource("../FXML/TeacherLogin.fxml"));
        if(check){
            ...
            TeacherRegisterResponse response=(TeacherRegisterResponse) Main.GetResponse();
